...
def fill():
    ...
    docs = [
        Document(department='computer science', lectures=[lectures[0], lectures[1], lectures[5]], examinants=[profs[3]],
                 ...
                 validated=True, has_file=True, early_document_reward_eligible=False, deposit_return_eligible=False),
        ...
        Document(department='computer science', lectures=[lectures[4], lectures[3], lectures[2]],
                 ...
                 number_of_pages=2, document_type='oral', validated=True, early_document_reward_eligible=False,
        ...
        Document(department='mathematics', lectures=[lectures[5], lectures[6], lectures[7]],
                 ...
                 number_of_pages=7, document_type='oral', validated=True, early_document_reward_eligible=False,
                 deposit_return_eligible=False),
        Document(department='mathematics', lectures=[lectures[5], lectures[6], lectures[7]],
                 ...
                 deposit_return_eligible=False),
        Document(department='mathematics', lectures=[lectures[5], lectures[6], lectures[7]],
                 examinants=[profs[3], profs[0], profs[2]], date=date(2001, 2, 3), validation_time=datetime(2001, 2, 4),
                 number_of_pages=2, document_type='oral', validated=False, submitted_by='Monty Montgomery',
                 early_document_reward_eligible=True, deposit_return_eligible=True),
        Document(department='mathematics', lectures=[lectures[5], lectures[6], lectures[7]],
                 examinants=[profs[3], profs[0], profs[2]], date=date(2001, 2, 3), validation_time=datetime(2001, 2, 4),
                 number_of_pages=2, document_type='oral', validated=False, submitted_by='Some other Monty',
                 early_document_reward_eligible=False, deposit_return_eligible=True),
    ]
